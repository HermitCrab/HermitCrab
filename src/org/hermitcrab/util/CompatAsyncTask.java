...
import org.hermitcrab.util.concurrent.ArrayDeque;
...
public abstract class CompatAsyncTask<Params, Progress, Result> {
	private static final String LOG_TAG = CompatAsyncTask.class.getSimpleName();
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		...
		public Thread newThread(Runnable r) {
			return new Thread(r, "RogusoTask #" + mCount.getAndIncrement());
		}
	};
	...
	public static final Executor DUMMY_EXECUTOR = new DummyExecutor();
	public static final Executor REVERSE_EXECUTOR = new SerialExecutor(true);
	...
	private static volatile Executor sDefaultExecutor = DUMMY_EXECUTOR;
	...
	private static class SerialExecutor implements Executor {
		...
		public SerialExecutor(boolean reverse) {
			super();
			mReverse = reverse;
		}
	...
	public CompatAsyncTask() {
		setDefaultExecutor(DUMMY_EXECUTOR);
	...
	private Result postResult(Result result) {
		Message message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
				new RogusoAsyncTaskResult<Result>(this, result));
	 ...
	 */
	public final CompatAsyncTask<Params, Progress, Result> execute(
			Params... params) {
	 ...
	 *             {@link AsyncTask.Status#FINISHED}.
	 */
	public final CompatAsyncTask<Params, Progress, Result> executeOnExecutor(
	...
	protected final void publishProgress(Progress... values) {
		if (!isCancelled()) {
			sHandler.obtainMessage(MESSAGE_POST_PROGRESS,
					new RogusoAsyncTaskResult<Progress>(this, values))
					.sendToTarget();
		}
	}
	...
	private static class InternalHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			RogusoAsyncTaskResult result = (RogusoAsyncTaskResult) msg.obj;
			switch (msg.what) {
	...
	private static class RogusoAsyncTaskResult<Data> {
		final CompatAsyncTask mTask;
		final Data[] mData;

		RogusoAsyncTaskResult(CompatAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
